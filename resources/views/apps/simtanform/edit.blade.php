                ...
                <div class="flex justify-between flex-wrap px-4">
                    <div class="mb-6 lg:w-1/2 w-full">
                        <div class="flex items-center text-black dark:text-white shrink-0">
                            <img src="/assets/images/Logo_Perkebunan_Nusantara_IV.png" alt="image" class="w-14" />
                        </div>
                    ...
                    <div class="lg:w-1/2 w-full lg:max-w-fit">
                        <div class="flex items-center">
                            <label for="number" class="flex-1 ltr:mr-2 rtl:ml-2 mb-0">SimtanForm Number</label>
                            <input id="number" type="text" name="inv-num" class="form-input lg:w-[250px] w-2/3"
                                placeholder="#8801" x-model="params.SimtanFormNo" />
                        </div>
                        <div class="flex items-center mt-4">
                            <label for="SimtanFormLabel" class="flex-1 ltr:mr-2 rtl:ml-2 mb-0">SimtanForm Label</label>
                            <input id="SimtanFormLabel" type="text" name="inv-label"
                                class="form-input lg:w-[250px] w-2/3" placeholder="Enter SimtanForm Label"
                                x-model="params.title" />
                        </div>
                        <div class="flex items-center mt-4">
                            <label for="startDate" class="flex-1 ltr:mr-2 rtl:ml-2 mb-0">SimtanForm Date</label>
                            <input id="startDate" type="date" name="inv-date" class="form-input lg:w-[250px] w-2/3"
                                x-model="params.SimtanFormDate" />
                        </div>
                        <div class="flex items-center mt-4">
                ...
                <div class="panel">
                    <div class="grid xl:grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4">
                        ...
                        <button type="button" class="btn btn-info w-full gap-2">
                            ...
                            Send SimtanForm </button>

                        <a href="/apps/SimtanForm/preview" class="btn btn-primary w-full gap-2">
        ...
        document.addEventListener("alpine:init", () => {
            Alpine.data('SimtanFormEdit', () => ({
                ...
                init() {
                    ...
                    this.params.SimtanFormDate = dt.getFullYear() + '-' + month + '-' + date;
