                ...
                <div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                    <div class="flex items-center gap-2 mb-5">
                        <button type="button" class="btn btn-danger gap-2" @click="deleteRow()">
                            ...
                            Delete </button>
                        <a href="/apps/SimtanForm/add" class="btn btn-primary gap-2">
            ...
            Alpine.data('SimtanFormList', () => ({
                    ...
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        ...
                        columns: [{
                            ...
                            },
                            {
                                select: 1,
                                render: function(data, cell, row) {
                                    return '<a href="/apps/SimtanForm/preview" class="text-primary underline font-semibold hover:no-underline">#' +
                                        data + '</a>';
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                render: function(data, cell, row) {
                                    return `<div class="flex gap-4 items-center">
                                                <a href="/apps/SimtanForm/edit" class="hover:text-info">
                                                ...
                                                <a href="/apps/SimtanForm/preview" class="hover:text-primary">
                ...
                searchSimtanForm() {
                    return this.items.filter((d) =>
                        (d.SimtanForm && d.SimtanForm.toLowerCase().includes(this.searchText)) ||
