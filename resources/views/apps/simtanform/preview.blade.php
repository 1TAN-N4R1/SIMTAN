{{-- <x-layout.default>
    ...
    <div x-data="SimtanFormPreview">
        <div class="flex items-center lg:justify-end justify-center flex-wrap gap-4 mb-6">
            ...
            <a href="/apps/SimtanForm/add" class="btn btn-secondary gap-2">
            ...
            <a href="/apps/SimtanForm/edit" class="btn btn-warning gap-2">
        ...
        <div class="panel">
            <div class="flex justify-between flex-wrap gap-4 px-4">
                <div class="text-2xl font-semibold uppercase">SimtanForm</div>
                <div class="shrink-0">
                ...
                <div class="flex justify-between sm:flex-row flex-col gap-6 lg:w-2/3">
                    <div class="xl:1/3 lg:w-2/5 sm:w-1/2">
                        <div class="flex items-center w-full justify-between mb-2">
                            <div class="text-white-dark">SimtanForm :</div>
                            <div>#8701</div>
                        </div>
                        <div class="flex items-center w-full justify-between mb-2">
