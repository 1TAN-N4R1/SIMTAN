    ...
    <div class="shadow-sm">
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/Logo_Perkebunan_Nusantara_IV.png"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">SIMTAN</span>
                </a>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span><img class="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                src="/assets/images/Logo_Perkebunan_Nusantara_IV.png" /></span> </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
        ...
        <ul
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="/">komposisiLahan</a>
                    </li>
                    <li>
                        <a href="/monitoringTM">monitoringTM</a>
                    </li>
                    <li>
                        <a href="/kebunTBM">kebunTBM</a>
                    </li>
                    <li>
                        <a href="/kebunTM">kebunTM</a>
                    </li>
                </ul>
            </li>
            <li class="menu nav-item relative">
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="https://SIMTAN.sbthemes.com" target="_blank">Documentation</a>
                    </li>
                </ul>
            </li>
        </ul>
