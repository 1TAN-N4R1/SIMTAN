        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/Logo_Perkebunan_Nusantara_IV.png"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">SIMTAN</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'dashboard'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/">Monitoring & Evaluasi TBM</a>
                        </li>
                        {{-- <li>
                            <a href="/monitoringTM">Monitoring & Evaluasi TM</a>
                        </li> --}}
                        <li>
                            <a href="/kebunTBM">Data Distrik & Kebun TBM</a>
                        </li>
                        {{-- <li>
                            <a href="/kebunTM">Data Distrik & Kebun TM</a>
                        </li> --}}
                    </ul>
                </li>
                    ...
                    <ul>
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                :class="{ 'active': activeDropdown === 'SimtanForm' }"
                                @click="activeDropdown === 'SimtanForm' ? activeDropdown = null : activeDropdown = 'SimtanForm'">
                                <div class="flex items-center">

                                    <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

                                        <path d="M7 3C5.89543 3 5 3.89543 5 5V19
             C5 20.1046 5.89543 21 7 21H17
             C18.1046 21 19 20.1046 19 19V9
             L14 3H7Z" stroke="currentColor" stroke-width="1.5" fill="none" />
                                        <path d="M14 3V9H19" stroke="currentColor" stroke-width="1.5" fill="none" />
                                        <line x1="8" y1="13" x2="12" y2="13"
                                            stroke="currentColor" stroke-width="1.5" />
                                        <line x1="8" y1="16" x2="12" y2="16"
                                            stroke="currentColor" stroke-width="1.5" />
                                        <path d="M15.5 13.5L18 16L13 21H10V18L15.5 13.5Z" fill="currentColor" />
                                    </svg>

                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">SimtanForm</span>
                                </div>
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === 'SimtanForm' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'SimtanForm'" x-collapse
                                class="sub-menu text-gray-500">
                                {{-- <li>
                                    <a href="/apps/SimtanForm/list">List</a>
                                </li>
                                <li>
                                    <a href="/apps/SimtanForm/preview">Preview</a>
                                </li> --}}
                                <li>
                                    <a href="/apps/SimtanForm/add">Add</a>
                                </li>
                                {{-- <li>
                                    <a href="/apps/SimtanForm/edit">Edit</a>
                                </li> --}}
                            </ul>
                        </li>
                        {{-- <li class="nav-item">
                ...
                <li class="menu nav-item">
                    {{-- <a href="https://SIMTAN.sbthemes.com" target="_blank" class="nav-link group">
                        <div class="flex items-center">
