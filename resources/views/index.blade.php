<x-layout.default>
    ...
    <div x-data="dashboardCharts" class="space-y-6">
        <!-- Breadcrumb -->
        <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <span>Monitoring & Evaluasi TBM</span>
            </li>
        </ul>

        <div class="panel h-[900px] xl:col-span-2">
            <div class="flex items-center mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Komposisi Lahan</h5>
            </div>
            <div class="overflow-hidden">
                <div x-ref="komposisiLahanChart" class="bg-white dark:bg-black rounded-lg min-h-[400px]">
                    <!-- Loader -->
                    <div
                        class="min-h-[400px] grid place-content-center bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08]">
                        <span
        ...
        <div class="relative">
            <div class="panel h-full xl:col-span-2">
                <div class="flex items-center dark:text-white-light mb-5">
                    <h5 class="font-semibold text-lg">Peringkat Kebun Berdasarkan Kondisi Pohon</h5>
                </div>

                <div class="overflow-hidden">
                    <div x-ref="peringkatKondisiPohonChart" class="w-[1500px] min-w-[900px]"></div>
                </div>
            </div>
        ...
        <div class="relative mt-6">
            <div class="panel h-full xl:col-span-2">
                <div class="flex items-center dark:text-white-light mb-5">
                    <h5 class="font-semibold text-lg">Peringkat Kebun Berdasarkan Pemeliharaan</h5>
                </div>

                <div class="overflow-hidden">
                    <div x-ref="peringkatPemeliharaanChart" class="w-[1500px] min-w-[900px]"></div>
                </div>
            </div>
        ...
        <div class="panel h-[900px] xl:col-span-2">
            <div class="flex items-center mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Trend Luas Areal Tahun Tanam</h5>
            </div>
            <div class="overflow-hidden">
                <div x-ref="luasArealTahunTanamChart" class="bg-white dark:bg-black rounded-lg min-h-[400px]">
                    <!-- Loader -->
                    <div
                        class="min-h-[400px] grid place-content-center bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08]">
                        <span
        ...
        <div class="panel h-[900px] xl:col-span-2">
            <div class="flex items-center mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Trend Luas Areal Tahun Tanam Per Kebun</h5>
            </div>
            <div class="overflow-hidden">
                <div x-ref="luasArealTahunTanamPerKebunChart" class="bg-white dark:bg-black rounded-lg min-h-[400px]">
                    <!-- Loader -->
                    <div
                        class="min-h-[400px] grid place-content-center bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08]">
                        <span
            ...
            <div class="panel h-full sm:col-span-2 xl:col-span-1">
                <div class="flex items-center mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">
                        Daily Komposisi Lahan
                        <span class="block text-white-dark text-sm font-normal">Go to columns for details.</span>
                    </h5>
                ...
                <div class="overflow-hidden">
                    <div x-ref="dailykomposisiLahanChart" class="bg-white dark:bg-black rounded-lg">
                        <!-- Loader -->
                        <div
        ...
        <div class="flex items-center dark:text-white-light mb-5">
            ...
            <div x-data="dropdown" @click.outside="open = false" class="dropdown ltr:ml-auto rtl:mr-auto">
                <a href="javascript:;" @click="toggle">
                    <svg class="w-5 h-5 text-black/70 dark:text-white/70 hover:!text-primary" viewBox="0 0 24 24"
    ...
    {{-- <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6 ml-4">
                ...
                <table>
                    ...
                    <tbody>
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            ...
                            <td><a href="/apps/SimtanForm/preview">#46894</a></td>
                            <td>$56.07</td>
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            ...
                            <td><a href="/apps/SimtanForm/preview">#76894</a></td>
                            <td>$126.04</td>
                            <td><span
                        ...
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            ...
                            <td><a href="/apps/SimtanForm/preview">#66894</a></td>
                            <td>$56.07</td>
                            <td><span class="badge bg-success shadow-md dark:group-hover:bg-transparent">Paid</span>
                            </td>
                        </tr>
                        <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                            ...
                            <td><a href="/apps/SimtanForm/preview">#75844</a></td>
                            <td>$110.00</td>
                            <td><span
                                    class="badge bg-secondary shadow-md dark:group-hover:bg-transparent">Shipped</span>
                            </td>
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("dashboardCharts", () => ({
                ...
                init() {
                    let isDark = this.$store.app.theme === "dark" || this.$store.app.isDarkMode;
                    let isRtl = this.$store.app.rtlClass === "rtl";

                    setTimeout(() => {
                        Alpine.nextTick(() => {
                            const container = this.$refs.peringkatKondisiPohonChart
                                ?.parentElement;
                            const prevScrollLeft = container?.scrollLeft || 0;

                            if (this.peringkatKondisiPohonChart) {
                                this.peringkatKondisiPohonChart.updateOptions(this
                                    .peringkatKondisiPohonChartOptions, true, true);
                            } else {
                                this.peringkatKondisiPohonChart = new ApexCharts(this
                                    .$refs
                                    .peringkatKondisiPohonChart, this
                                    .peringkatKondisiPohonChartOptions);
                                this.peringkatKondisiPohonChart.render().then(() => {
                        ...
                        const container2 = this.$refs.peringkatPemeliharaanChart?.parentElement;
                        const prevScrollLeft2 = container2?.scrollLeft || 0;

                        if (this.peringkatPemeliharaanChart) {
                            this.peringkatPemeliharaanChart.updateOptions(this
                                .peringkatPemeliharaanChartOptions, true, true);
                        } else {
                            this.peringkatPemeliharaanChart = new ApexCharts(this.$refs
                                .peringkatPemeliharaanChart, this
                                .peringkatPemeliharaanChartOptions);
                            this.peringkatPemeliharaanChart.render().then(() => {
                                requestAnimationFrame(() => {
                                    container2.scrollLeft = prevScrollLeft2;
                                });
                            });
                        }
                        ...
                        this.$refs.komposisiLahanChart.innerHTML = "";
                        this.komposisiLahanChart.render();

                        this.luasArealTahunTanamChart = new ApexCharts(this.$refs
                            .luasArealTahunTanamChart, this.luasArealTahunTanamChartOptions);
                        this.$refs.luasArealTahunTanamChart.innerHTML = "";
                        this.luasArealTahunTanamChart.render();

                        this.luasArealTahunTanamPerKebunChart = new ApexCharts(
                            this.$refs.luasArealTahunTanamPerKebunChart,
                            this.luasArealTahunTanamPerKebunChartOptions
                        );
                        this.$refs.luasArealTahunTanamPerKebunChart.innerHTML = "";
                        this.luasArealTahunTanamPerKebunChart.render();


                        this.dailykomposisiLahanChart = new ApexCharts(this.$refs
                            .dailykomposisiLahanChart, this.dailykomposisiLahanChartOptions);
                        this.$refs.dailykomposisiLahanChart
                            .innerHTML = "";
                        this.dailykomposisiLahanChart.render();
                    ...
                    this.$watch('$store.app.theme', () => {
                        ...
                        this.luasArealTahunTanamPerKebunChart.updateOptions(this
                            .luasArealTahunTanamPerKebunChartOptions);
                        this.dailykomposisiLahanChart.updateOptions(this
                            .dailykomposisiLahanChartOptions);
                ...
                get peringkatKondisiPohonChartOptions() {
                    return {
                        series: [{
                                name: 'PKK NORMAL',
                ...
                get peringkatPemeliharaanChartOptions() {
                    return {
                        series: [{
                                name: 'Kacangan',
                ...
                get luasArealTahunTanamChartOptions() {
                    return {
                        chart: {
                            type: 'area',
                            height: 360,
                        ...
                        yaxis: {
                            ...
                            labels: {
                                formatter: val => `${val.toFixed(0)} Ha`,
                                style: {
                                    fontSize: '12px'
                                }
                            }
                        ...
                        tooltip: {
                            ...
                            y: {
                                formatter: val => `${val.toFixed(2)} Ha`
                            }
                        },
                        colors: ['#4CAF50'],
                        grid: {
                ...
                // get luasArealTahunTanamPerKebunChartOptions() {
                //     return {
                //         chart: {
                //             height: 600,
                //             type: 'line',
                ...
                //         series: series.map(s => ({
                //             name: s.name,
                //             type: s.name === 'TOTAL' ? 'line' : 'column',
                //             data: s.data
                //         })),

                //         stroke: {
                //             width: series.map(s => s.name === 'TOTAL' ? 3 : 0),
                //             curve: 'smooth'
                //         },

                //         fill: {
                //             opacity: series.map(s => s.name === 'TOTAL' ? 1 : 0.85)
                //         },
                ...
                //         dataLabels: {
                //             enabled: true,
                //             enabledOnSeries: series.map((s, i) => s.name === 'TOTAL' ? i : null)
                //                 .filter(i => i !== null),
                //             style: {
                //                 fontSize: '13px',
                //                 fontWeight: 600,
                ...
                //             },
                //             offsetY: -8,
                //             formatter: val => val > 0 ? `${val.toFixed(1)} Ha` : ''
                //         },
                ...
                //             intersect: false,
                //             y: {
                //                 formatter: val => val === 0 ? null : `${val.toFixed(2)} Ha`
                //             }
                //         },
                ...
                //         colors: [
                //             '#4F81BD', '#A9D18E', '#FFD966', '#ED7D31', '#9DC3E6', '#C6E0B4',
                //             '#F4B183', '#D9D9D9', '#B4A7D6', '#FFE699', '#A2D9CE', '#D5A6BD',
                //             '#BFBFBF', '#FCE4D6', '#D0CECE'
                //         ]
                //     };
                // },
                ...
                get luasArealTahunTanamPerKebunChartOptions() {
                    return {
                        chart: {
                            type: 'bar',
                            height: namaKebunTerluas.length * 30 + 100,
                            stacked: true,
                            toolbar: {
                                show: true,
                                tools: {
                        ...
                        dataLabels: {
                            ...
                            formatter: function(val) {
                                return val > 100 ? `${val.toFixed(1)} Ha` : '';
                            }
                        },
                        xaxis: {
                            categories: namaKebunTerluas,
                        ...
                        colors: [
                            '#4F81BD', // Biru lembut
                            '#A9D18E', // Hijau pastel
                            '#FFD966', // Kuning lembut
                            '#ED7D31', // Oranye lembut
                            '#9DC3E6', // Biru langit muda
                            '#C6E0B4', // Hijau pudar
                            '#F4B183', // Oranye terang lembut
                            '#D9D9D9', // Abu terang
                            '#B4A7D6', // Ungu pastel
                            '#FFE699', // Kuning muda
                            '#A2D9CE', // Toska muda
                            '#D5A6BD', // Pink keunguan
                            '#BFBFBF', // Abu netral
                            '#FCE4D6', // Peach muda
                            '#D0CECE', // Abu muda pastel
                            '#B7DEE8', // Biru aqua pastel
                            '#FAC090', // Oranye soft terang
                            '#FF5C5C'
                        ]
                    };
                },

                // get dailykomposisiLahanChartOptions() {
                //     return {
                //         chart: {
                //             type: 'bar',
                //             height: 350
                //         },
                //         series: [{
                //             data: komposisiSeries
                //         }],
                //         xaxis: {
                //             categories: komposisiLabels
                //         }
                //     };
                // },
