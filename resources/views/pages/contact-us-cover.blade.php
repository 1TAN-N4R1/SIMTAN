                ...
                <div
                    ...
                    <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                        <a href="/" class="w-48 block lg:w-72 ms-10">
                            <img src="assets/images/Logo_Perkebunan_Nusantara_IV.png" alt="Logo" class="w-full" />
                        </a>
                ...
                <div
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form class="space-y-5" @submit.prevent="window.location='/'">
                            ...
                            <div class="relative text-white-dark">
                                <textarea id="Textarea" rows="4" class="form-textarea resize-none ps-10 placeholder:text-white-dark"
                    ...
                    <p class="absolute bottom-6 w-full text-center dark:text-white">
                        © <span id="footer-year">2022</span>. SIMTAN All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
