<x-layout.default>
    ...
    <div>
        <div
            ...
            <div
                ...
                <img :src="$store.app.theme === 'dark' || $store.app.isDarkMode ? '/assets/images/faq/faq-dark.svg' :
                    ...
                    alt="faqs" class="w-56 object-cover xl:w-80" />
            </div>
            <div class="relative">
                ...
                <p class="mb-9 text-center text-base font-semibold">Search instant answers & questions asked by popular
                    users</p>
                ...
                <div class="flex flex-wrap items-center justify-center gap-2 font-semibold text-[#2196F3] sm:gap-5">
                    ...
                    <div class="flex items-center justify-center gap-2 sm:gap-5">
                        <a href="javascript:;" class="duration-300 hover:underline"> komposisiLahan</a>
                        <a href="javascript:;" class="duration-300 hover:underline"> Charts</a>
                        <a href="javascript:;" class="duration-300 hover:underline"> kebunTBM</a>
        ...
        <h3 class="mb-8 text-center text-xl font-semibold md:text-2xl">Frequently asked <span
                class="text-primary">questions</span></h3>
                ...
                <div class="divide-y divide-white-light px-6 py-4.5 dark:divide-dark">
                    <div>
                        <div class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            ...
                            <span>How to install SIMTAN Admin</span>
                    ...
                    <div>
                        <div class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light dark:bg-[#1B2E4B] !text-primary': active === 2 }"
                    ...
                    <div>
                        <div class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light dark:bg-[#1B2E4B] !text-primary': active === 3 }"
                    ...
                    <div>
                        <div class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light dark:bg-[#1B2E4B] !text-primary': active === 5 }"
        ...
        <div class="panel mt-10 text-center md:mt-20">
            ...
            <div class="text-lg font-medium text-white-dark">
                Our specialists are always happy to help. Contact us during standard business hours or email us24/7 and
