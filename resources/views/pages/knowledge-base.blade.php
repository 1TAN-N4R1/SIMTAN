<x-layout.default>
    ...
    <div x-data="knowledge">
        <div
            ...
            <div
                class="absolute bottom-20 end-5 hidden text-[#DBE7FF] rtl:rotate-y-180 dark:text-[#1B2E4B] md:block xl:bottom-14 xl:end-10">
                <svg width="375" height="185" viewBox="0 0 375 185" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g clip-path="url(#clip0_1109_89938)">
                        ...
                        <path
                            ...
                            fill="#2F2E41" />
                        <path d="M307.899 24.6635L307.791 25.4761L312.184 26.0541L312.292 25.2415L307.899 24.6635Z"
                            fill="#2F2E41" />
                        <path d="M321.765 26.4873L321.657 27.2998L326.05 27.8778L326.158 27.0653L321.765 26.4873Z"
                            fill="#2F2E41" />
                        <path
        ...
        <h3 class="mb-8 text-center text-xl font-semibold md:text-2xl">Some common <span
        ...
        <div
            ...
            <div class="flex-1 py-3.5 text-center md:text-start">
                ...
                <div class="text-lg font-medium text-white-dark">
                    Loaded with awesome features like documentation, knowledge base forum, domain transfer, affiliates
                    etc.
                </div>
            ...
            <div class="w-52 max-w-xs lg:w-full">
                <img src="/assets/images/knowledge/find-solution.svg" alt="find-solution"
                ...
                <template x-for="(item, i) in items" :key="i">
                    <div
                        ...
                        <div class="relative h-[340px] overflow-hidden rounded-md group">
                            <img :src="item.src" alt="video tutorial"
                                class="h-full w-full object-cover cursor-pointer" @click="toggle" />
                            <button type="button"
                                ...
                                @click="toggle">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="h-[62px] w-[62px]">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60" :class="open && '!block'">
                <div class="flex min-h-screen items-start justify-center px-4" @click.self="open = false">
                    <div x-show="open" x-transition x-transition.duration.300
                        class="my-8 w-full max-w-3xl overflow-hidden">
                        ...
                        <iframe src="https://www.youtube.com/embed/tgbNymZ7vqY"
                            class="h-[250px] w-full md:h-[550px]"></iframe>
                    </div>
                </div>
            </div>
        </div>
