    ...
    <div x-data="chart">
        <div class="grid xl:grid-cols-3 gap-6 mb-6">
            <div class="panel h-full xl:col-span-2">
                ...
                <div class="relative overflow-hidden">
                    <div x-ref="PeringkatKondisiPohonChart" class="bg-white dark:bg-black rounded-lg">
                        <!-- loader -->
                        <div
            ...
            <div class="panel h-full">
                <div class="flex items-center mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">komposisiLahan By Category</h5>
                </div>
                <div class="overflow-hidden">
                    <div x-ref="komposisiLahan" class="bg-white dark:bg-black rounded-lg">
                        <!-- loader -->
                        <div
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
            <div class="panel h-full sm:col-span-2 xl:col-span-1">
                <div class="flex items-center mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">Daily komposisiLahan <span
                ...
                <div class="overflow-hidden">
                    <div x-ref="dailykomposisiLahan" class="bg-white dark:bg-black rounded-lg">
                        <!-- loader -->
                        <div
                        ...
                        <div class="flex">
                            ...
                            <div>
                                <h5 class="font-semibold dark:text-white-light">New project created : <a
                                        href="javascript:;" class="text-success">[SIMTAN Admin Template]</a></h5>
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("chart", () => ({
                ...
                init() {
                    const PeringkatKondisiPohonChart = null;
                    const komposisiLahan = null;
                    const dailykomposisiLahan = null;
                    ...
                    setTimeout(() => {
                        // revenue
                        this.PeringkatKondisiPohonChart = new ApexCharts(this.$refs
                            .PeringkatKondisiPohonChart,
                            this.PeringkatKondisiPohonChartOptions)
                        this.$refs.PeringkatKondisiPohonChart.innerHTML = "";
                        this.PeringkatKondisiPohonChart.render()

                        // komposisiLahan by category
                        this.komposisiLahan = new ApexCharts(this.$refs
                            .komposisiLahan,
                            this.komposisiLahanOptions)
                        this.$refs.komposisiLahan.innerHTML = "";
                        this.komposisiLahan.render()

                        // daily komposisiLahan
                        this.dailykomposisiLahan = new ApexCharts(this.$refs
                            .dailykomposisiLahan,
                            this.dailykomposisiLahanOptions)
                        this.$refs.dailykomposisiLahan.innerHTML = "";
                        this.dailykomposisiLahan.render()
                    ...
                    this.$watch('$store.app.theme', () => {
                        ...
                        this.komposisiLahan.updateOptions(this
                            .komposisiLahanOptions);
                        this.dailykomposisiLahan.updateOptions(this.dailykomposisiLahanOptions);
                ...
                // daily komposisiLahan
                get dailykomposisiLahanOptions() {
                    return {
                        series: [{
                                name: 'komposisiLahan',
