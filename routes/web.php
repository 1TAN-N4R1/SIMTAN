...
use App\Http\Controllers\SimtanFormController;
use App\Http\Controllers\KebunTBMController;
use App\Http\Controllers\MailboxController;

Route::get('/', [IndexController::class, 'index'])->name('index');

Route::get('/apps/SimtanForm/add', [SimtanFormController::class, 'create'])->name('simtanform.add');
Route::get('/simtanform/get-kode/{kategori}', [SimtanFormController::class, 'getKodeUpload'])->name('simtanform.getKode');
Route::post('/apps/SimtanForm/store', [SimtanFormController::class, 'store'])->name('simtanform.store');

Route::view('/apps/SimtanForm/list', 'apps.simtanform.list');
Route::view('/apps/SimtanForm/preview', 'apps.simtanform.preview');
Route::view('/apps/SimtanForm/edit', 'apps.simtanform.edit');

// Route::view('/kebunTBM', 'kebun-tbm');
Route::get('/kebunTBM', [KebunTBMController::class, 'index'])->name('kebun-tbm.index');
Route::get('/kebunTBM/{kodeView}', [KebunTBMController::class, 'show'])->name('kebun-tbm.show');

// Tetap pakai view statis jika tidak pakai controller
Route::view('/monitoringTM', 'monitoring-tm');
Route::view('/kebunTM', 'kebun-tm');

Route::view('/apps/chat', 'apps.chat');

Route::get('/apps/mailbox', [MailboxController::class, 'index'])->name('mailbox.index');
